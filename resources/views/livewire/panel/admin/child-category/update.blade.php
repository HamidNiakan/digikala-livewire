<div>
    @section('title','ویرایش دسته بندی کودک')
    <div class="main-content padding-0">
        <p class="box__title">ویرایش دسته بندی کودک : {{$childCategory->title}}</p>
        <div class="col-12 bg-white padding-0">
            <form wire:submit.prevent="update" class="padding-20 needs-validation">
                ...
                <div class="form-check">
                    <input class="form-check-input @if($errors->has('icon')) is-invalid @endif @if($childCategory->is_published !== null) is-valid @endif" wire:model.defer="childCategory.is_published" type="checkbox" value="" id="flexCheckDefault">
                ...
                @else
                    @if($childCategory->getFirstMediaUrl('childCategory-icon','thumb'))
                        <div class="img-thumbnail mb-3">
                            <img class="img-fluid" src="{{$childCategory->getFirstMediaUrl('childCategory-icon','thumb')}}">
                        </div>
                    @endif
                @endif
                &nbsp;
