<div>
    ...
    <div class="main-content padding-0">
        ...
        <div class="col-12 bg-white padding-0">
            <form wire:submit.prevent="store" class="padding-20 needs-validation">
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12 mb-5" wire:ignore>
                        <textarea class="form-control" rows="5" placeholder=" توضیحات کوتاه" id="short-description"></textarea>
                    </div>
                    <div class="col-12 mb-5" wire:ignore>
                        <textarea class="form-control" rows="5" placeholder=" توضیحات " id="description"></textarea>
                    </div>
                </div>
                <div class="row">
