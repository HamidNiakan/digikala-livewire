...
class AddSubCategoryRequest extends FormRequest
{
    ...
    {
		return [
			'subCategory.title' => 'required|unique:sub_categories,title',
			'subCategory.slug' => 'required|unique:sub_categories,slug|regex:/^[a-zA-Z-]+$/u',
			'subCategory.link' => 'required|unique:sub_categories,link|regex:/^[a-zA-Z-]+$/u',
	...
	public function messages () {
		return [
			...
			'icon.required' => 'ایکون زیر دسته بندی را آپلود کنید',
